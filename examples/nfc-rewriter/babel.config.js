 ...
 * so changes to `../../src` reload live in this example without a rebuild.
 * This example lives one directory deeper than `../self-test`, so the
 * relative path up to the repo root has one extra `..`.
 */
module.exports = {
